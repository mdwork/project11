...
$form['common-form'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Форма обратной связи (общая форма)',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'stroy@keys.com',
		'from_name' => 'noreply',
		'to_email' => 'mazdze@gmail.com',
		'to_name' => 'noreply',
		'geoip' => true,
		'referer' => false,
		'type' => 'plain',
		...
		'okay' => 'Ваше сообщение отправлено.',
...
$form['form-repair'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Форма обратной связи (заказ ремонта)',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'stroy@keys.com',
		'from_name' => 'noreply',
...
$form['consultation-form'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Форма обратной связи (заказ консультации-1)',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'stroy@keys.com',
		'from_name' => 'noreply',
...
$form['consultation-work-form'] = array(
	'fields' => array(
		'name' => array(
			'title' => 'Имя',
            'validate' => array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Форма обратной связи (заказ консультации и работ)',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'stroy@keys.com',
		'from_name' => 'noreply',
...
$form['consultation-form-2'] = array(
	'fields' => array(
		'name' => array(
			'title' => 'Имя',
            'validate' => array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Форма обратной связи (заказ консультации-2)',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'stroy@keys.com',
		'from_name' => 'noreply',
...
$form['common-form-popup'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Форма обратной связи (модальное окно)',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'stroy@keys.com',
		'from_name' => 'noreply',
